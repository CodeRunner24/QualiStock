...
var ro = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  ...
  let q2 = { disabled: D, loading: D, onClick: () => {
    ...
    if (v.status === "success" && (n2 != null && n2.invalidateOnClose) && m({ id: k, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: c }), H)
...
var no2 = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  ...
  let j = z(), { warnWhen: x, setWarnWhen: K } = vt(), $ = { disabled: D, onClick: () => {
    ...
    if (H.status === "success" && (n2 != null && n2.invalidateOnClose) && p({ id: T, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: y }), x)
...
var Ct = o2(({ Title: e2, render: t, meta: r }) => {
  let [s, n2] = (0, import_react90.useState)(false), [i, a] = (0, import_react90.useState)(false), p = yo(), l = oe(), m = yt(), { warnWhen: u, setWarnWhen: d } = vt(), { Link: c } = pe(), f = l === "legacy" ? c : m, h = Ta(), y = z(), { menuItems: g, selectedKey: b, defaultOpenKeys: P } = zu({ meta: r }), B = grid_default.useBreakpoint(), { hasDashboard: C } = ge(), S = ie(), { mutate: k } = Mr({ v3LegacyAuthProviderCompatible: !!(S != null && S.isLegacy) }), F = typeof B.lg > "u" ? false : !B.lg, D = e2 ?? h ?? Ft, T = o2((E, q2) => E.map((L) => {
    ...
    if (w.length > 0)
      return import_react90.default.createElement(Sc, { key: L.key, resource: z2, action: "list", params: { resource: L } }, import_react90.default.createElement(menu_default.SubMenu, { key: L.key, icon: O ?? import_react90.default.createElement(UnorderedListOutlined_default, null), title: M }, T(w, q2)));
...
var Lt = o2(({ Title: e2, render: t, meta: r }) => {
  let { token: s } = theme_default.useToken(), [n2, i] = (0, import_react94.useState)(false), [a, p] = (0, import_react94.useState)(false), l = yo(), m = oe(), u = yt(), { warnWhen: d, setWarnWhen: c } = vt(), { Link: f } = pe(), h = m === "legacy" ? f : u, y = Ta(), g = z(), { menuItems: b, selectedKey: P, defaultOpenKeys: B } = zu({ meta: r }), C = grid_default.useBreakpoint(), { hasDashboard: S } = ge(), k = ie(), { mutate: F } = Mr({ v3LegacyAuthProviderCompatible: !!(k != null && k.isLegacy) }), D = typeof C.lg > "u" ? false : !C.lg, T = e2 ?? y ?? kt, v = o2((E, q2) => E.map((L) => {
    let { icon: O, label: M, route: Y, key: N, name: z2, children: w, parentName: R, meta: J, options: X } = L;
    if (w.length > 0)
      return import_react94.default.createElement(Sc, { key: L.key, resource: z2, action: "list", params: { resource: L } }, import_react94.default.createElement(menu_default.SubMenu, { key: L.key, icon: O ?? import_react94.default.createElement(UnorderedListOutlined_default, null), title: M }, v(w, q2)));
    let se = N === q2, _ = !(I(J == null ? void 0 : J.parent, X == null ? void 0 : X.parent, R) !== void 0 && w.length === 0);
...
var Rt = o2(({ Title: e2, render: t, meta: r, fixed: s, activeItemDisabled: n2 = false }) => {
  ...
  let { token: i } = theme_default.useToken(), { siderCollapsed: a, setSiderCollapsed: p, mobileSiderOpen: l, setMobileSiderOpen: m } = fo2(), u = yo(), d = (Y = (0, import_react98.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : Y.direction, c = oe(), f = yt(), { warnWhen: h, setWarnWhen: y } = vt(), { Link: g } = pe(), b = c === "legacy" ? g : f, P = Ta(), B = z(), { menuItems: C, selectedKey: S, defaultOpenKeys: k } = zu({ meta: r }), F = grid_default.useBreakpoint(), { hasDashboard: D } = ge(), T = ie(), { mutate: v } = Mr({ v3LegacyAuthProviderCompatible: !!(T != null && T.isLegacy) }), U = typeof F.lg > "u" ? false : !F.lg, H = e2 ?? P ?? be, j = o2((N, z2) => N.map((w) => {
    ...
    if (fe.length > 0)
      return import_react98.default.createElement(Sc, { key: w.key, resource: _, action: "list", params: { resource: w } }, import_react98.default.createElement(menu_default.SubMenu, { key: w.key, icon: R ?? import_react98.default.createElement(UnorderedListOutlined_default, null), title: J }, j(fe, z2)));
